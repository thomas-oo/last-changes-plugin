...
public class GitMultiLastChangesTest {
    ...
    @Before
    public void before() {
        gitRepoPath = GitMultiLastChangesTest.class.getResource("/git-sample-repo").getFile();
    ...
    public void shouldGetLastChangesFromInitialCommitGitRepo() throws FileNotFoundException {
        String repositoryLocation = GitMultiLastChangesTest.class.getResource("/git-initial-commit-repo").getFile();
